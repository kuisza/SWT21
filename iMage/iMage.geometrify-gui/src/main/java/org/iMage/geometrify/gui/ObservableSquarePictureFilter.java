 ...
 *
 */
public class ObservableSquarePictureFilter extends SquarePictureFilter {

	private List<PictureFilterObserver> observers = new LinkedList<>();

	/**
	 * Constructs a new instance of a {@link ObservableSquarePictureFilter}
	 * 
	 * @param pointGenerator
	 *            The {@link IPointGenerator} to be used for generating
	 *            {@link Point}s
	 */
	public ObservableSquarePictureFilter(IPointGenerator pointGenerator) {
