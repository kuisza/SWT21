 ...
 *
 */
public class ObservableCirclePictureFilter extends CirclePictureFilter {

	private List<PictureFilterObserver> observers = new LinkedList<>();

	/**
	 * Constructs a new instance of a {@link ObservableCirclePictureFilter}
	 * 
	 * @param pointGenerator
	 *            The {@link IPointGenerator} to be used for generating
	 *            {@link Point}s
	 */
	public ObservableCirclePictureFilter(IPointGenerator pointGenerator) {
