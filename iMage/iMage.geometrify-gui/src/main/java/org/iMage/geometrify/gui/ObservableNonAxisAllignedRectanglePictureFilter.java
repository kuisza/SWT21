...
import org.iMage.geometrify.NonAxisAllignedRectanglePictureFilter;
 ...
 *
 */
public class ObservableNonAxisAllignedRectanglePictureFilter extends NonAxisAllignedRectanglePictureFilter {

	private List<PictureFilterObserver> observers = new LinkedList<>();

	/**
	 * Constructs a new instance of a {@link ObservableNonAxisAllignedRectanglePictureFilter}
	 * 
	 * @param pointGenerator
	 *            The {@link IPointGenerator} to be used for generating
	 *            {@link Point}s
	 */
	public ObservableNonAxisAllignedRectanglePictureFilter(IPointGenerator pointGenerator) {
