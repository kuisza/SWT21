 ...
 *
 */
public class ObservableEllipsePictureFilter extends EllipsePictureFilter {

	private List<PictureFilterObserver> observers = new LinkedList<>();

	/**
	 * Constructs a new instance of a {@link ObservableEllipsePictureFilter}
	 * 
	 * @param pointGenerator
	 *            The {@link IPointGenerator} to be used for generating
	 *            {@link Point}s
	 */
	public ObservableEllipsePictureFilter(IPointGenerator pointGenerator) {
