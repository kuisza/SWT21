...
@MetaInfServices(AbstractPrimitivePictureFilter.class)
public class NonAxisAllignedRectanglePictureFilter extends AbstractPrimitivePictureFilter{
	 ...
	 */
	public NonAxisAllignedRectanglePictureFilter() {
	...
	public String getName() {
		...
		return "NonAxisAllignedRectanglePictureFilter";
	}
	...
	protected IPrimitive generatePrimitive() {
		return new NonAxisAllignedRectangle(pointGenerator.nextPoint(), pointGenerator.nextPoint(), pointGenerator.nextPoint());
	}
